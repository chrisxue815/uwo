...
2. MAR: The memory address register stores the address of the location in main memory that is currently being accessed by a read or write operation.
3. MBR: The memory buffer register stores data that has just been read from main memory or data to be immediately written to main memory.
4. IR: The instruction register stores the instruction most recently read from main memory. This is the instruction currently being executed.
...
2. `MOV r3, r1, LSR r2` = 00FF<sub>16</sub>
3. `MVN r3, r1, LSL r2` = 000F<sub>16</sub> or FFFF000F<sub>16</sub>
4. `MVN r3, r1, LSR r2` = FF00<sub>16</sub> or FFFFFF00<sub>16</sub>
...
2. `ADD r0, r1, r1, LSL #4` = 10EF<sub>16</sub>
3. `ADD r0, r1, r1, ROR #4` = F000010E<sub>16</sub>
...
Rotate right r3 by 3 bits, add the result to r2, and store r0 to the memory pointed at by r2.
...
1. `STRB r1, [r2]`:
   * `0xE5C21000`
   * `0b 1110 0101 1100 0010 0001 0000 0000 0000`
2. `LDR r3, [r4, r5]!`:
   * `0xE7B43005`
   * `0b 1110 0111 1011 0100 0011 0000 0000 0101`
3. `LDR r3, [r4], r5`:
   * `0xE6943005`
   * `0b 1110 0110 1001 0100 0011 0000 0000 0101`
4. `LDR r3, [r4, #-6]!`:
   * `0xE5343006`
   * `0b 1110 0101 0011 0100 0011 0000 0000 0110`
...
Logical shift left r6 by r2, and load r0 with the word pointed at by register r5 plus r6.
...
2. At the start of the program, register r1 contains the address of the first character in the string, and r2 contains the address of the last character. On exit from the program, register r 0 contains a 0 if the string is not a palindrome, and 1 if it is.
